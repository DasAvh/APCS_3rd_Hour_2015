...
public class Card extends Entity
{
	...
	public static void initialize(Game game)
	{
		...
		for(int x = 0; x < Assets.chars.size(); x++)
		{
			...
			playerCards.add(new PlayerCard(game, colPadding, rowPadding, CARD_WIDTH, CARD_HEIGHT, x, temp[0], temp[1], temp[2]));
		...
		for(PlayerCard p : playerCards)
			System.out.println(p.getName() + " " + p.getSlogan() + " " + p.getInterSlogan());
